...
class SimpleConvNet:
    ...
    def __init__(self, input_dim=(1, 28, 28), 
                conv_param={'filter_num':30, 'filter_size':5, 'pad':0, 'stride':1},
                hidden_size=100, output_size=10, trainweight=0):
        ...
        # 重みの初期化
        self.params = {}
        self.params['W1'] = trainweight["W1"]
        self.params['b1'] = trainweight["b1"]
        self.params['W2'] = trainweight["W2"]
        self.params['b2'] = trainweight["b2"]
        self.params['W3'] = trainweight["W3"]
        self.params['b3'] = trainweight["b3"]
